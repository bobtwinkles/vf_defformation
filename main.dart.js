...
"%":"ArrayBuffer|Blob|CanvasRenderingContext2D|DOMError|DOMImplementation|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|Range|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|WebGLBuffer|WebGLProgram|WebGLShader|WebGLUniformLocation"},
yE:{
"^":"Gv;",
...
$.X3.toString
this.ZL(a,b)},function(a){return this.w0(a,null)},"pm","$2","$1","gYJ",2,2,18,19]},
Zf:{
"^":"Pf;MM",
...
static:{"^":"fi,QZ,RV,lF,os,M9,nG,IN,vj,bO"}},
vs:{
"^":"a;YM,t9<,O1",
...
P.HZ(this,z)},function(a){return this.ZL(a,null)},"yk","$2","$1","gFa",2,2,20,19],
Xf:function(a){var z
...
$isa6:true,
static:{"^":"Wt,S4,dk,uU,zj,b2,jS,Ie,Do,Cv,kT,IJ,D9,Vk,S8,rG",xC:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"^":"Tp:25;",
...
"%":"HTMLFormElement"},
zU:{
"^":"wa;Im:readyState=,il:responseText=,pf:status=",
...
m6:{
"^":"a;Ks<",
i0:function(a){return this.WD.tg(0,a.tagName)},
...
cu:{
"^":"d5;",
"%":"SVGLinearGradientElement;SVGGradientElement"}}],["","",,P,{
"^":"",
Jo:{
"^":"Gv;Bm:drawingBufferHeight=,ZY:drawingBufferWidth=",
v3:function(a,b,c){return a.attachShader(b,c)},
LT:function(a,b,c,d){return a.bindAttribLocation(b,c,d)},
...
z[1]=y[1]*b
z[0]=y[0]*b
return new T.aI(z)}b.gFB()
throw H.b(P.u(b))},
g:function(a,b){var z,y
z=new Float32Array(H.T0(16))
y=this.Ev
z[0]=C.CD.g(y[0],b.gEv().t(0,0))
z[1]=C.CD.g(y[1],b.gEv().t(0,1))
z[2]=C.CD.g(y[2],b.gEv().t(0,2))
z[3]=C.CD.g(y[3],b.gEv().t(0,3))
z[4]=C.CD.g(y[4],b.gEv().t(0,4))
z[5]=C.CD.g(y[5],b.gEv().t(0,5))
z[6]=C.CD.g(y[6],b.gEv().t(0,6))
z[7]=C.CD.g(y[7],b.gEv().t(0,7))
z[8]=C.CD.g(y[8],b.gEv().t(0,8))
z[9]=C.CD.g(y[9],b.gEv().t(0,9))
z[10]=C.CD.g(y[10],b.gEv().t(0,10))
z[11]=C.CD.g(y[11],b.gEv().t(0,11))
z[12]=C.CD.g(y[12],b.gEv().t(0,12))
z[13]=C.CD.g(y[13],b.gEv().t(0,13))
z[14]=C.CD.g(y[14],b.gEv().t(0,14))
z[15]=C.CD.g(y[15],b.gEv().t(0,15))
return new T.aI(z)},
...
g:function(a,b){var z,y,x,w,v
z=this.Ev
y=C.CD.g(z[0],b.gEv().t(0,0))
x=C.CD.g(z[1],b.gEv().t(0,1))
w=C.CD.g(z[2],b.gEv().t(0,2))
z=C.CD.g(z[3],b.gEv().t(0,3))
...
J.wY($.Wy,34962,z.Zj)
J.wY($.Wy,34963,z.cR)
J.GB($.Wy,0,2,5126,!1,20,0)
J.GB($.Wy,1,3,5126,!1,20,8)
J.Hb($.Wy,z.dh,z.od,5123,0)
$.Ii.Ww()
J.i3($.Wy,0)
J.i3($.Wy,1)
for(y=0;y<5;++y)T.vD($.Ix,0.001)
C.ol.gm6(window).ml(T.Lo())},"$1","Lo",2,0,7],
Iq:[function(){P.JS("science")
var z=J.YP($.jY())
$.Wy=z
if(z==null){P.JS("couldn't initialize gl!")
return}P.JS("starting loop!")
$.rZ=0
T.nR($.ec()).ml(T.IC()).ml(new T.em())},"$0","KW",0,0,1],
Wg:function(a,b,c){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j
z=6*a*(a-1)-6
y=a*a
x=c.Ev
w=b.Ev
...
u=x[1]-w[1]
x=$.Wy
t=new T.f5(null,null,null,null,null,null,null,null)
t.jo(x,y,4)
t.hT(x,y,z,4)
for(s=0,r=0;r<a;++r)for(x=u*(r/a),q=r*a,p=0;p<a;++p){o=p+q
t.u(0,o,new T.nX(v*(p/a)+w[0],x+w[1],0,1,0))
if(s<z){n=t.jb
m=n.length
if(s<0||s>=m)return H.e(n,s)
n[s]=o
l=s+1
k=o+1
...
for(y=0;y<b;++y){x=y/b
w=a.Ev
z.u(0,y,new T.nX(w[0],w[1],0,x,1-x))
a=T.qu(a,0.01)}return z},
...
t=J.lA($.Wy,35632)
z=J.U6(a)
J.Rb($.Wy,u,J.CA(z.t(a,"shaders/base.vert")))
J.Rb($.Wy,t,J.CA(z.t(a,"shaders/base.frag")))
J.Ef($.Wy,u)
if(J.uW($.Wy,u,35713)!==!0){P.JS("vert failed to compile: ")
P.JS(J.lP($.Wy,u))}J.Ef($.Wy,t)
if(J.uW($.Wy,t,35713)!==!0){P.JS("frag failed to compile: ")
P.JS(J.lP($.Wy,t))}z=J.WG($.Wy)
$.ou=z
J.to($.Wy,z,u)
J.to($.Wy,$.ou,t)
J.CW($.Wy,$.ou,0,"position")
J.CW($.Wy,$.ou,1,"color")
J.Zi($.Wy,$.ou)
if(J.U3($.Wy,$.ou,35714)!==!0){P.JS("Failed to link program")
P.JS(J.LV($.Wy,$.ou))}J.jO($.Wy,$.ou)
...
y[0]=0
y[1]=0.2
$.Ii=T.Ag(new T.z3(y),128)},"$1","IC",2,0,8],
iM:function(a,b){var z=document.createElement("span",null)
z.setAttribute("class",b===0?"log-item log-item-error":"log-item")
J.IR(z,"beforeend",a)
$.SJ().appendChild(z)},
vD:function(a,b){var z,y,x,w,v,u,t,s
for(z=0;z<a.bd;++z){y=5*z
x=a.Mq
w=x.length
...
v=x[0]
s=w.length
if(y>=s)return H.e(w,y)
w[y]=v
x=x[1]
if(u>=s)return H.e(w,u)
w[u]=x}a.Rk=!1},
...
if(x>=2)T.iM(J.AG(z.gpf(y)),0)
x=z.gIm(y)
if(typeof x!=="number")return x.F()
if(x>=3)T.iM(J.AG(z.gil(y)),0)
throw H.b(a)},"$1","aD",2,0,9],
iU:[function(a){var z,y,x,w,v
z=P.L5(null,null,null,P.qU,W.zU)
for(y=J.GP(a);y.G();){x=y.gl()
w=J.U6(x)
v=w.t(x,0)
z.u(0,w.t(x,1),v)}return z},"$1","Dh",2,0,10],
nR:function(a){var z,y,x,w,v,u,t
z=[]
for(y=new H.a7(a,2,0,null);y.G();){x=y.lo
w=P.e4(new T.hk(x),null).ml(new T.TK(x))
v=$.X3
u=new P.vs(0,v,null)
u.$builtinTypeInfo=[null]
if(v!==C.NU)t=P.VH(T.aD(),v)
else t=T.aD()
w.xf(new P.Fe(null,u,2,null,t))
z.push(u.ml(new T.nf(x)))}return P.pH(z,!1).ml(T.Dh())},
em:{
"^":"Tp:13;",
$1:function(a){return C.ol.gm6(window).ml(T.Lo())}},
nX:{
"^":"a;x>,y>,r>,UI<,b<"},
zA:{
"^":"a;Mq,Zj,bd,dh,Rk",
BF:function(){J.wY($.Wy,34962,this.Zj)
J.P1($.Wy,34962,this.Mq,35044)
this.Rk=!0},
Ww:function(){if(!this.Rk)this.BF()
J.wY($.Wy,34962,this.Zj)
J.GB($.Wy,0,2,5126,!1,20,0)
J.GB($.Wy,1,3,5126,!1,20,8)
J.iw($.Wy,this.dh,0,this.bd)},
bV:function(){var z,y,x,w,v,u,t,s,r,q,p
for(z=0;z<this.bd;++z){y=z*5
x=this.Mq
w=x.length
if(y>=w)return H.e(x,y)
v=x[y]
...
if(u>=w)return H.e(x,u)
q=x[u]
p=H.d(v)+" "+H.d(t)+" "+H.d(s)+" "+H.d(r)+" "+H.d(q)
H.qw(p)}},
...
y[x]=w
this.Rk=!1},
jo:function(a,b,c){this.Mq=new Float32Array(H.T0(b*5))
this.Zj=J.Rw(a)
this.bd=b
this.dh=c
this.Rk=!1},
static:{mR:function(a,b,c){var z=new T.zA(null,null,null,null,null)
z.jo(a,b,c)
return z}}},
f5:{
"^":"zA;jb,cR,od,Mq,Zj,bd,dh,Rk",
BF:function(){J.wY($.Wy,34963,this.cR)
J.P1($.Wy,34963,this.jb,35044)
T.zA.prototype.BF.call(this)},
hT:function(a,b,c,d){this.od=c
this.jb=new Uint16Array(H.T0(c))
this.cR=J.Rw($.Wy)}},
tZ:{
"^":"a;Dz,wh,R,fg,wU",
bu:function(a){var z,y,x,w
...
x=this.R
w=this.fg
return"[Viewport: ("+z+", "+H.d(y)+") -> ("+(z+x)+", "+H.d(y+w)+") ["+x+" "+H.d(w)+"]]"}},
hk:{
"^":"Tp:11;a",
$0:function(){return T.iM("Fetching "+H.d(this.a),4)}},
TK:{
"^":"Tp:13;b",
$1:function(a){return W.GN(this.b,null,null,null,null,null,null,null)}},
nf:{
"^":"Tp:28;c",
$1:function(a){var z=this.c
T.iM("Fetched "+H.d(z),4)
return[a,z]}}},1],])
...
J.CW=function(a,b,c,d){return J.RE(a).LT(a,b,c,d)}
...
J.P1=function(a,b,c,d){return J.RE(a).Vl(a,b,c,d)}
...
I.$lazy($,"undefinedLiteralCallPattern","cz","yV",function(){return H.cM(function(){var $argumentsExpr$='$arguments$'
...
init.metadata=[{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"DZ",ret:P.KN,args:[P.a]},{func:"Vv",ret:P.a2,args:[W.cv,P.qU,P.qU,W.JQ]},{func:"QB",void:true,args:[P.FK]},{func:"cM",void:true,args:[[P.Z0,P.qU,W.zU]]},{func:"pp",void:true,args:[W.hY]},{func:"DB",ret:[P.Z0,P.qU,W.zU],args:[null]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"uO",args:[P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"rf",args:[P.a]},{func:"Ns",void:true,args:[P.a],opt:[P.mE]},,{func:"Vx",void:true,args:[null],opt:[P.mE]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},{func:"qu",void:true,args:[W.KV]},{func:"Za",args:[P.qU,null]},{func:"c3",args:[W.zU]},];$=null
